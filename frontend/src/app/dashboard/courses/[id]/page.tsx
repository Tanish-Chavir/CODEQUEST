...
`);
  ...
  const videoSrc = (currentVideo && progressLoaded)
    ? `https://www.youtube-nocookie.com/embed/${currentVideo.videoId}?autoplay=1&mute=1&rel=0&enablejsapi=1&start=${startSeconds}`
    : null;
