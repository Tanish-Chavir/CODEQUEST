    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {courses.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {courses.map((course) => (
            <div key={course._id} className="bg-card border border-border rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all group">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mt-4">
                  ...
                  <Link href={`/dashboard/courses/${course._id}`} className="text-sm font-medium hover:text-primary transition-colors flex items-center gap-1">
